    ...
    <div className="bg-[url('/background.jpg')] min-h-screen bg-cover bg-center bg-no-repeat">
        <div className="flex justify-between pl-[2vw] pr-[2vw] pt-2">
            ...
            <div className="mt-1 flex gap-4">
                <button className="px-6 py-3 rounded-full bg-[#c8ff00] text-black font-semibold hover:cursor-pointer hover:text-white hover:bg-transparent border-[#c8ff00] border-2">
                    Get Started
                </button>

                <button className="px-6 py-3 rounded-full text-white border-[#c8ff00] border-2 hover:cursor-pointer hover:bg-white/10">
                    Sign In
                </button>
            </div>
        </div>
